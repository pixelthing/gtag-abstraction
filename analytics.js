...
var gaAbstract = (function() {
    ...
    var eventSelectors = {
        ...
        '#age' : {
            type             : 'change',
            event_category   : 'quiz-spel:steg0',
        ...
        '#user_details-0+#quiz-0 .button[disabled]' : {
            event_category   : 'quiz-spel:steg0',
            event_action     : 'submit (inaktiverad)'
        },
        '#user_details-0+#quiz-0 .button:not([disabled])' : {
        ...
        // page 2
        '#quiz-0.step-2 .button.border:not([disabled])' : {
            event_category   : 'quiz-spel:steg2',
            event_action     : 'back'
        },
        '#quiz-0.step-2 .button:not(.border):not([disabled])' : {
            event_category   : 'quiz-spel:steg2',
            event_action     : 'submit'
        },
        '#quiz-0.step-2 .button:not(.border)[disabled]' : {
            event_category   : 'quiz-spel:steg2',
            event_action     : 'submit (inaktiverad)'
        },
        // page 3
        '#quiz-0.step-3 .button.border:not([disabled])' : {
            event_category   : 'quiz-spel:steg3',
            event_action     : 'back'
        },
        '#quiz-0.step-3 .button:not(.border):not([disabled])' : {
            event_category   : 'quiz-spel:steg3',
            event_action     : 'submit'
        },
        '#quiz-0.step-3 .button:not(.border)[disabled]' : {
            event_category   : 'quiz-spel:steg3',
            event_action     : 'submit (inaktiverad)'
        },
        // page 4
        '#quiz-0.step-4 .button.border:not([disabled])' : {
            event_category   : 'quiz-spel:steg4',
            event_action     : 'back'
        },
        '#quiz-0.step-4 .button:not(.border):not([disabled])' : {
            event_category   : 'quiz-spel:steg4',
            event_action     : 'submit'
        },
        '#quiz-0.step-4 .button:not(.border)[disabled]' : {
            event_category   : 'quiz-spel:steg4',
            event_action     : 'submit (disabled)'
        },
        // page 5
        '#quiz-0.step-5 .button.border:not([disabled])' : {
            event_category   : 'quiz-spel:steg5',
            event_action     : 'back'
        },
        '#quiz-0.step-5 .button:not(.border):not([disabled])' : {
            event_category   : 'quiz-spel:steg5',
            event_action     : 'submit'
        },
        '#quiz-0.step-5 .button:not(.border)[disabled]' : {
            event_category   : 'quiz-spel:steg5',
            event_action     : 'submit (disabled)'
        },
        // page 6
        '#quiz-0.step-6 .button.border:not([disabled])' : {
            event_category   : 'quiz-spel:steg6',
            event_action     : 'back'
        },
        '#quiz-0.step-6 .button:not(.border):not([disabled])' : {
            event_category   : 'quiz-spel:steg6',
            event_action     : 'submit'
        },
        '#quiz-0.step-6 .button:not(.border)[disabled]' : {
            event_category   : 'quiz-spel:steg6',
            event_action     : 'submit (disabled)'
        },
        // bjud in
        ...
        '.invite-form .button.disabled' : {
            event_category   : 'quiz-spel:steg7',
            event_action     : 'bjuda (disabled)'
        },
        '#invite_family-0+#quiz-0 .button:not([disabled])' : {
            event_category   : 'quiz-spel:steg7',
            event_action     : 'submit'
        },
        // results
    ...
    var registerSwipeEvent = function () {
        ...
        $doc.on( 'mouseup touchend', el, function( ev ) {
            ...
            if ( swipedX > swipedY && Math.abs( swipedX ) > 5 && timerLength > 100 ) {
                var payload = {
                    event_category   : 'quiz-spel:resultat',
                    event_action     : 'more - swipe'
                };
